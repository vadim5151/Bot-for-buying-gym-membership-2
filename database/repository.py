...
class UserRepository:
    ...
    async def add_temp_message_id(self, tg_id, temp_message_id):
        await collection_users.update_one(filter={'tg_id': tg_id},  update={'$push': {'temp_message_ids': temp_message_id}})
    ...
    async def delete_temp_messages(self, tg_id, chat_id, bot):
        ...
        await collection_users.update_one(filter={'tg_id': tg_id}, update={'$set':{'temp_message_ids': []}})
